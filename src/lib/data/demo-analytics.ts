...
export const DEMO_ORG_EXECUTION: OrgExecutionPoint[] = [
  { org: "SED", execution: 72, projects: 6, delayed: 1 },
  { org: "SES", execution: 65, projects: 8, delayed: 2 },
  { org: "SEGOV", execution: 81, projects: 4, delayed: 0 },
  { org: "SEFAZ", execution: 58, projects: 5, delayed: 1 },
  { org: "SEJUSP", execution: 49, projects: 7, delayed: 3 },
  { org: "SEAD", execution: 54, projects: 3, delayed: 1 },
  { org: "SEMADESC", execution: 61, projects: 5, delayed: 1 },
];
...
export const DEMO_ATTENTION_ITEMS: AttentionItem[] = [
  ...
  {
    id: "att-02",
    title: "Metas próximas do vencimento — ciclo 2026",
    org: "SEGOV",
    tone: "warning",
    label: "Atenção",
    category: "meta",
  ...
  {
    id: "att-03",
    title: "SEAD sem atualização há 15 dias",
    org: "SEAD",
    tone: "warning",
  ...
  {
    id: "att-04",
    title: "Risco crítico de aquisição — SEILOG",
    org: "SEILOG",
    tone: "danger",
    label: "Risco crítico",
    category: "risco",
...
export const DEMO_REPORT_DEFINITIONS: ReportDefinition[] = [
  {
    id: "rep-01",
    code: "REL-EXEC-EST",
    name: "Execução estadual consolidada",
    description:
      "Resumo de contratos, projetos, entregas e alertas por secretaria.",
    audience: "Governador / SEGOV",
    formats: ["csv", "pdf"],
    defaultFilters: ["ciclo=2026", "visao=estadual"],
  },
  {
    id: "rep-02",
    code: "REL-SED-DET",
    name: "Detalhamento da secretaria",
    description:
      "Projetos, indicadores, orçamento e pendências da secretaria selecionada.",
  ...
  },
  {
    id: "rep-03",
    code: "REL-MUN",
    name: "Painel municipal",
    description: "Investimento, projetos e status por município.",
    audience: "SEGOV / Territorial",
    formats: ["csv"],
...
export const DEMO_EXPORT_JOBS: ExportJob[] = [
  {
    ...
    reportName: "Execução estadual consolidada",
    format: "csv",
    requestedBy: "Fernanda Oliveira Costa",
    requestedAt: "2026-08-03 16:40",
    status: "disponivel",
    rowCount: 7,
    fileName: "execucao-estadual-2026-08-03.csv",
  },
  {
    id: "exp-02",
    reportCode: "REL-MUN",
    reportName: "Painel municipal",
    format: "csv",
    requestedBy: "Ana Paula Ribeiro",
    requestedAt: "2026-08-02 11:15",
    status: "disponivel",
    rowCount: 79,
    fileName: "painel-municipal-2026-08-02.csv",
  },
  {
    id: "exp-03",
    reportCode: "REL-SED-DET",
    reportName: "Detalhamento da secretaria",
    format: "xlsx",
